            ...
            <div className="about-us-top">
              <div className="aut-left">
                {about.id !== -1 ? (
                  ...
                  <Skeleton highlightColor={highlightColor} height={'5.4rem'} width={'45%'} />
                )}
            ...
            <div className="about-us-middle">
              {about.id !== -1 ? (
                <div className="aub-wrapper">
                  <Statistic count={about.tournment_number} title={about.tournment_title} />
                  <Statistic count={about.organisation_number} title={about.organisation_title} />
                  <Statistic count={about.graduate_number} title={about.graduate_title} />
                  <Statistic count={about.places_number} title={about.places_title} />
                </div>
              ) : (
