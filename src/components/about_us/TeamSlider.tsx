...
const TeamSlider = () => {
  const [team, setTeam]: [PlayersData[], React.Dispatch<PlayersData[]>] = useState([
    {
      id: -1,
      title: '',
      name: '',
  ...
  return (
    <div className="team">
      <Swiper
        ...
        spaceBetween={48}
        slidesPerView={
          breakpoints['500'] ? 1 : breakpoints['860'] ? 2 : breakpoints['1200'] ? 3 : 4
        }
        loop={true}
        navigation={{
          nextEl: '.slider-next',
              ...
              return (
                <SwiperSlide key={uuidv4()}>
                  <div className="team-skeleton">
                    <Skeleton width={'100%'} height={'35rem'} highlightColor={highlightColor} />
                    <Skeleton width={'20rem'} height={'2.5rem'} highlightColor={highlightColor} />
                  </div>
                </SwiperSlide>
              );
            })}
